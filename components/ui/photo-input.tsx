      ...
      <div className="flex items-center gap-3">
        ...
        {value && !disabled && (
          <button
            ...
            className="flex items-center gap-1 text-xs font-semibold text-muted hover:text-red-500 border-2 border-dashed border-border bg-primary-light/40 rounded-full p-2"
          >
            <X size={14} /> Quitar
          </button>
        )}
