  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-sm">
        <CardBody>
          <Link href="/login" className="mb-3 inline-flex items-center gap-1.5 text-sm font-semibold text-muted hover:text-ink">
            <ArrowLeft size={15} /> Volver a iniciar sesión
          </Link>
          <h1 className="text-xl font-extrabold tracking-tight text-ink">Recuperar contraseña</h1>
          ...
          {resetUrl === undefined ? (
            ...
            <div className="mt-6 flex flex-col gap-3 rounded-xl border border-border bg-primary-light/30 p-4 text-sm">
